...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // check for files i.e. img and avatar
...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  if (!fullName && !email) {
    throw new ApiError(400, "All fields are required email & name");
  }
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Avatar got updated successfully"));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Cover Image got updated successfully"));
});
